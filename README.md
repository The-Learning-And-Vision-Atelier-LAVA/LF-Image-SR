...
| **LF-DFnet** | [**arXiv2020**](https://arxiv.org/pdf/2007.03535.pdf) |  | **deformable convolution, disparity-robust** | **LFBM5D, GB, LFNet, LFSSR, resLF, LF-ATO(comparable), LF-InterNet(comparable)**, *VDSR, EDSR, RCAN, SAN, SRGAN, ESRGAN* |
